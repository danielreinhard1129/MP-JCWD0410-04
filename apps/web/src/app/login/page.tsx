...
<div className="container mx-auto max-w-100 h-screen bg-[url('/kpop1.jpeg')] bg-cover bg-center bg-no-repeat flex justify-center items-center">
  <div className="w-96 p-4 rounded-3xl shadow sm:p-8 bg-white text-black1">
	...
	<p className="my-4 text-sm text-center dark:text-gray-600">Don't have an account?
		<Link href="/register" rel="noopener noreferrer" className="focus:underline hover:underline"> Sign up here</Link>
	</p>
	...
	<form className="space-y-8">
		...
		<button type="button" className="w-full px-8 py-3 font-semibold rounded-full bg-blue1 hover:bg-blue3 text-white">Sign in</button>
	</form>
</div>
    </div>
  )
