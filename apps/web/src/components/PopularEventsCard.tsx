...
const PopularEventsCard = () => {
  return (
    <Link href="/detail">
	  <div className="card  bg-[url('/kpop1.jpeg')] bg-cover bg-center shadow-md  h-[400px] w-[280px] group gap-[0.5em] rounded-[1.5em] relative flex justify-end flex-col p-[1.5em] z-[1] overflow-hidden ">
      <div className="absolute h-full w-full  inset-x-0 bottom-0 bg-gradient-to-t from-black/60 to-transparent"></div>
      <div className="container text-black z-[2] relative flex flex-col gap-[0.5em]">
