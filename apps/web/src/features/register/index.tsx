    ...
    <AuthForm>
      ...
      <div className="my-6 space-y-4">
        <button
          ...
          type="button"
          className="flex h-10 w-full items-center justify-center space-x-4 rounded-full border border-grey2 p-4 hover:bg-grey1 focus:ring-2 focus:ring-offset-1"
        >
          <svg
      ...
      <hr className="my-8 w-full dark:text-gray-600" />
