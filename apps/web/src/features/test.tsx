...
//   const getSearchProperty = async (inputText: string, inputNumber: number) => {
//     const { data } = await axiosInstance.get('/property', {
//       params: { search: { inputText, inputNumber }, take: 20 },
//     });
...
//       inputText: string,
//       inputNumber: number,
//       callback: (option: SearchPropertyOption[]) => void,
//     ) => {
//       getSearchProperty(inputText, inputNumber).then((option) =>
//         callback(option),
//       );
//     },
//     500,
...
//         <Button
//           className="w-full"
//           onClick={(property) => router.push(/property/${property})}
//         >
//           Search
//         </Button>
//       </div>
